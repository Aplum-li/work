...
<script type="text/javascript" src="/data/js/jquery1.42.min.js"></script>
    ...
    <TD vAlign=top background=images/aa_3.gif height=39>
		...
		<TR>
		  <TD vAlign=bottom align=right height=39 style="background:url(images/aa_2.gif) no-repeat left top; color:#FFFFFF;">
			...
			</script><?php echo $_SESSION['m_name']?>&nbsp;&nbsp;		  </TD>
		</TR>
		</TBODY>
		</TABLE>	 </TD>
  </TR>
  <TR>
    <TD vAlign=top background=images/aa_3_2.gif><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
			  ...
			  <TD width=79><A  href="<?php echo ADMIN;?>/login.php?do=quit" target="_top" class=nav onmouseover="MM_swapImage('Image26','','images/lg2.gif',1)" onmouseout=MM_swapImgRestore() ><IMG height=30 src="images/lg1.gif" border=0 name=Image26></A></TD>
			  <TD width=79><A  onmouseover="MM_swapImage('Image27','','images/out2.gif',1)" onmouseout=MM_swapImgRestore() href="<?php echo ADMIN;?>/login.php?do=quit" target="_parent" onclick="return log_out()"><IMG height=30 src="images/out1.gif" border=0 name=Image27></A></TD>
			  <TD><A href="javascript:clearCache();" class="nav"  onmouseover="MM_swapImage('Image25','','images/ch2.gif',1)" onmouseout=MM_swapImgRestore() style="float:left;"><IMG height=30 src="images/ch1.gif" border=0 name=Image25></A> <span id="clearc" style="display:none;text-align:left;color:#fff;float:left;line-height:30px;">更新成功</span></TD>
			 </TR>
			 </TBODY>
			</TABLE>	 </TD>
   </TR>
...
function clearCache(){
	$.post("<?php echo ADMIN;?>/clearCache.php", 
	   function(data){
	    if (data) {
	    	$('#clearc').show();
	    	setTimeout(function(){$('#clearc').fadeOut();},1000)
	    }else{
	    	$('#clearc').show();
	    	setTimeout(function(){$('#clearc').fadeOut();},1000)
	    }
