...
//分类表
$rotation_type_table = 'flink_type';
            ...
            <form name="myform" id="myform" method="post" action="post.php">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a href="flink_type_edit.php?type=add&"><i class="fa fa-plus-square"></i> 新增分类</a>
                        <?php }?>
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr class="del_<?php echo $v['id']?>">
                            ...
                            <td style='text-align:left;text-indent:10px;'>
                                <span style="float:left;"><a href="flink_list.php?typeid=<?php echo $v['id'];?>" class='b edit'><?php echo $v['flink_type_name']?></a>
                                </span> 
                            </td>
                            <td>
                            		<?php if(manager(38)){ ?>
                            		<a class="link-update" href="flink_type_edit.php?id=<?php echo $v['id'];?>&type=edit">修改</a><?php }?>
                            		<?php if($_SESSION['role_id'] == 1){ ?> | 
